...
public class ZipUtils {
    ...
    public static void createZipDemo(String sourceFilePath, String targetZipFilePath, String[] names) throws IOException {
        ZipOutputStream zos = new ZipOutputStream(new FileOutputStream(targetZipFilePath));
        //创建zip压缩包
        writeZip(zos, new File(sourceFilePath), "");
        ...
        for (String name : names) {
            ZipEntry zipEntry = new ZipEntry("申报" + File.separator + name);
